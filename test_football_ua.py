...
browser = webdriver.Remote(
    ...
    options=options)
browser.set_page_load_timeout(const_waits_long)
browser.get(url)    # visit site

# WebDriverWait(browser, const_waits_long).until(EC.presence_of_element_located((By.XPATH, advertisment_xpath))).click()    # wait and click advertisment
# WebDriverWait(browser, const_waits_long).until(EC.presence_of_element_located((By.XPATH, phones_xpath))).click()
# WebDriverWait(browser, const_waits_long).until(EC.presence_of_element_located((By.XPATH, advertisment_2_xpath))).click()    # wait and click advertisment page 2
...
browser.save_screenshot("screenshots/screen1.png")
